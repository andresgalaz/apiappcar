...
module.exports = function(req, res) {
    ...
    db.scoreDB.knex.raw("call prScoreVehiculoRangoFecha(?,?,?,?,?,?,?)", [req.user.pUsuario, nPeriodo, cFecIni, cFecFin, nIdVehiculo, nIdConductor, req.body.noViajes=='true']).then(function(data) {
        if (data === null) {
