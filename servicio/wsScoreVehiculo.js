...
module.exports = function(req,res){
	...
	if( req.body.idUsuario !== undefined ){
		...
		// qConductor.andWhere	("fUsuario", req.body.idUsuario);
		...
		qIdViaje.andWhere	("fUsuario", req.user.pUsuario);
		qVeh.andWhere		("fUsuario", req.user.pUsuario);
		//qConductor.andWhere	("fUsuario", req.user.pUsuario);
		qViaje.andWhere		("fUsuario", req.user.pUsuario);
		qConductor.andWhere	("fUsuarioTitular", req.user.pUsuario);
	}
	...
	try {
		...
		for( var i=0 ; i < arrVeh.length ; i++){
			...
			arrVeh[i].eventos = [ { idEvento: '3', tipoEvento: 'Aceleración'     , cantidad: 0 }
    							, { idEvento: '4', tipoEvento: 'Frenada'         , cantidad: 0 }
    							, { idEvento: '5', tipoEvento: "Exceso Velocidad", cantidad: 0 }];
		}
